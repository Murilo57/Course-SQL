...
* Você consegue criar essas chaves através de restrições (ou constraints em inglês), que são regras que vc define quando está criando uma coluna
* Assim quando você faz isso você está criando um indice unico para aquela coluna ou grupo de colunas

> O que é uma chave estrangeira

* Uma chave estrangeira é uma coluna ou grupo de colunas em uma taela que identifica unicamente uma linha em outra tabela.
...
* Nos podemos entender que uma chave estrangeira mantem a "integridade refencial"